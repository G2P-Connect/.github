...
> ### This is an open source joint initiative to offer an integrated G2P solution blueprint using a plug-n-play architecture to enable choice of components, a set of integration specifications to ensure interoperability, and an integration sandbox for various DPG providers to join the effort 
adhering to the blueprint and specifications to offer a well architected, well documented, and pre-integrated G2P solution.
